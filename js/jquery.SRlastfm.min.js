...
html+='</ul>';}else{html+='<p>No items to display</p>';e};html+='</div>';$e.append(html);};var _getValidURL=function(u){var url=u;if(u!=''&&u.substr(0,7)!='https://')url='https://'+u;return url;};})(jQuery);